...
1. **Interface web simple** (Streamlit ou Gradio)
2. **Amélioration du chunking** (préservation de structure)
3. **Templates Word** professionnels (style Bernadet)
4. **Régénération de sections**
5. **Upload d'images/annexes**
6. **Interface d'édition**
