...
DO $$ BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE sections ADD COLUMN reviewer_id UUID REFERENCES users(id) ON DELETE SET NULL;
    END IF;
...
DO $$ BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE memoires ADD COLUMN uploaded_by UUID REFERENCES users(id) ON DELETE SET NULL;
    END IF;
